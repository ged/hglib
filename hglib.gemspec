# -*- encoding: utf-8 -*-
# stub: hglib 0.11.0.pre.20201228153258 ruby lib

Gem::Specification.new do |s|
  s.name = "hglib".freeze
  s.version = "0.11.0.pre.20201228153258"
  ...
  s.date = "2020-12-28"
  s.description = "This is a client library for the Mercurial distributed revision control tool that uses the Command Server for efficiency.".freeze
  ...
  s.required_ruby_version = Gem::Requirement.new(["~> 2.5".freeze, ">= 3.0".freeze])
  s.rubygems_version = "3.2.3".freeze
  s.summary = "This is a client library for the Mercurial distributed revision control tool that uses the Command Server for efficiency.".freeze
